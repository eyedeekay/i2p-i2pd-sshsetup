...
`This guide is also available in i2p: 566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzuq.b32.i2p <http://566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzuq.b32.i2p>`__
...
.. |Use the wizard to create a "Server" tunnel| image:: server.png
.. |Of the "Standard" variety| image:: standard.png
.. |Describe what it is for| image:: describe.png
.. |Point it at the future home of your SSH server| image:: hostport.png
.. |Save the settings.| image:: approve.png
.. |Configure your tunnel for interactive connectionss| image:: interactive.png
.. |If you're not concerned about anonymity, then reduce tunnel length.| image:: anonlevel.png
.. |Reduce on idle, if you chose a high number of tunnels| image:: idlereduce.png
.. |Use the wizard to create a client tunnel| image:: client.png
.. |Of the Standard variety| image:: clientstandard.png
.. |Give it a good description| image:: clientdescribe.png
.. |Find the destination you want to connect to| image:: finddestination.png
.. |Affix the destination| image:: fixdestination.png
.. |Choose a local port| image:: clientport.png
.. |Decide if you want it to autostart| image:: clientautostart.png
.. |Configure it to be interactive| image:: clientinteractive.png
.. |Get the client destination| image:: whitelistclient.png
.. |And paste it onto the server whitelist| image:: whitelistserver.png
